...
#
#     PHX_SERVER=true bin/kitrank start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :kitrank, KitrankWeb.Endpoint, server: true
end
  ...
  config :kitrank, KitrankWeb.Endpoint,
    live_reload: [
      ...
      patterns: [
        ...
        ~r"lib/kitrank_web/router\.ex$"E,
        ~r"lib/kitrank_web/(controllers|live|components)/.*\.(ex|heex)$"E
      ]
    ]
end
...
if config_env() == :prod do
  ...
  config :kitrank, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
